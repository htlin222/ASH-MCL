...
format:
  revealjs:
    ...
    preview-links: auto
    logo: ""
    footer: "ASH 2025 | B-Cell Lymphoma Updates"
    transition: none
    width: 1600
    height: 900
    revealjs-plugins:
...
# Mantle Cell Lymphoma (MCL) {background-color="#2E86AB"}
...
# Marginal Zone Lymphoma (MZL) {background-color="#2E86AB"}
...
# Waldenström Macroglobulinemia (WM) {background-color="#2E86AB"}
...
# Clinical Implications {background-color="#1A5276"}
